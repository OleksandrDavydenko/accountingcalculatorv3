...
export const Menu = () => {
  ...
  return (
    <div className={active_cls}>
      <div className={classes.btn_conteiner} onClick={toggleHeandler}>
        <p className={classes.title}>MENU</p>
        <div className={classes.menu_button_position}>
          <MenuButton toggleHeandler={toggleHeandler} toggleState={toggle} />
        </div>
      </div>
      <NavItems toggleState={toggle} />
      <p className={classes.version}>Version 1.0.4</p>
    </div>
  );
};
